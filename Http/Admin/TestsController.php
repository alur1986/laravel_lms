...
class TestsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.tests.index', compact('categories'));
    }
    ...
    public function create()
    {
        ...
        $categories = $categories->pluck('name', 'id')->prepend('Please select', '');
        $lessons = \App\Models\Lesson::whereIn('category_id', $categories_ids)->get()->pluck('name', 'id')->prepend('Please select', '');

        return view('backend.tests.create', compact('categories', 'lessons'));
    }
